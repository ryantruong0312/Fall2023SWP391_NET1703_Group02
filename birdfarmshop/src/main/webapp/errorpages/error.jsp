    ...
    <body>
        ...
        <div class="container container-bird">
            ...
            <div class="container-title">
                ...
                <div class="subtitle">Oops. Có vẻ bạn đã gặp lỗi khi chuyển trang.</div>
                <button><a style="text-decoration: none;" href="MainController?action=NavToHome">Trở về trang chính</a></button>
            </div>
        </div>
    </body>
</html>
