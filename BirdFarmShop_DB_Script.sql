...
VALUES 
	...
	('RL391',N'Rainbow Lory',N'đen, đỏ, tím, xanh lá, vàng',5,4,0,N'Vẹt Châu Úc',NULL,0,9500000,N'Lông nhiều màu sắc rực rỡ, mỏ cam, tính cách vui vẻ, tươi mới, yêu đời. Yêu thích tương tác và cần chế độ ăn uống đa dạng, hoạt động vui chơi để duy trì sức khỏe tốt và làm phong phú cuộc sống của người nuôi.',null,null,0,N'pairing'),
